...
class StorageManager:
    ...
    def load_split(self, split_name: str, task: str = 'clarity'):
        """
        Load dataset split by reloading dataset from HuggingFace and selecting indices
        This makes splits runtime-independent (no HuggingFace cache dependencies)
        ...
        Returns:
            Dataset split loaded from HuggingFace using saved indices
        """
        import pickle
        ...
        # Reload dataset from HuggingFace
